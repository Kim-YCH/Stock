...
const CACHE_VERSION = "v11.17.10";
const CACHE_NAME = "stocklab-shell-" + CACHE_VERSION;
const SHELL_ASSETS = [
  "./",
  "./index.html",
  "./css/style.css?v=11.17.10",
  "./js/config.js?v=11.17.10",
  "./js/api.js?v=11.17.10",
  "./js/indicator-explain.js?v=11.17.10",
  "./js/app.js?v=11.17.10",
  "./icons/favicon.svg",
  "./manifest.json"
];
